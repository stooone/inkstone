...
import {Shortstraw} from '/lib/matcher/external/zz85nus/shortstraw';
import {recognize} from '/lib/matcher/recognizer';
import {getShortcuts} from '/lib/matcher/shortcuts';
...
class Matcher {
  ...
  match(stroke, missing) {
    ...
    this._candidates.forEach((candidate, i) => {
      ...
      const first_index = Math.min(...candidate.indices);
